...
public class MicrowaveStatemachine implements IMicrowaveStatemachine {
	...
	public boolean isStateActive(State state) {
		...
		case microwave_System:
			return stateVector[0].ordinal() >= State.
					microwave_System.ordinal()&& stateVector[0].ordinal() <= State.microwave_System_Cook_Finish_finish_Finish_off.ordinal();
		case microwave_System_Door_Ouvert:
	...
	*/
	...
	/* Entry action for state 'Finish_on'. */
	private void entryAction_Microwave_System_Cook_Finish_finish_Finish_on() {
	...
	/* Entry action for state 'Finish_off'. */
	private void entryAction_Microwave_System_Cook_Finish_finish_Finish_off() {
	...
	private void exitAction_Microwave_System_Cook_Finish_finish_Finish_on() {
		timer.unsetTimer(this, 1);
	}
	
	/* Exit action for state 'Finish_off'. */
	private void exitAction_Microwave_System_Cook_Finish_finish_Finish_off() {
	...
	private void enterSequence_Microwave_System_Cook_Cook_cook_cook_active_default() {
		entryAction_Microwave_System_Cook_Cook_cook_cook_active();
		nextStateIndex = 1;
	...
	private void enterSequence_Microwave_System_Cook_Finish_finish_Finish_on_default() {
		entryAction_Microwave_System_Cook_Finish_finish_Finish_on();
		nextStateIndex = 1;
		stateVector[1] = State.microwave_System_Cook_Finish_finish_Finish_on;
	}
	
	/* 'default' enter sequence for state Finish_off */
	private void enterSequence_Microwave_System_Cook_Finish_finish_Finish_off_default() {
		entryAction_Microwave_System_Cook_Finish_finish_Finish_off();
		nextStateIndex = 1;
	...
	/* 'default' enter sequence for region cook */
	private void enterSequence_Microwave_System_Cook_Cook_cook_default() {
		react_Microwave_System_Cook_Cook_cook__entry_Default();
	}
	
	/* 'default' enter sequence for region finish */
	private void enterSequence_Microwave_System_Cook_Finish_finish_default() {
		react_Microwave_System_Cook_Finish_finish__entry_Default();
	}
	...
	/* Default exit sequence for state Cook */
	private void exitSequence_Microwave_System_Cook_Cook() {
	...
	/* Default exit sequence for state cook_active */
	private void exitSequence_Microwave_System_Cook_Cook_cook_cook_active() {
		nextStateIndex = 1;
		stateVector[1] = State.$NullState$;
	...
	private void exitSequence_Microwave_System_Cook_Finish() {
		exitSequence_Microwave_System_Cook_Finish_finish();
	}
	
	/* Default exit sequence for state Finish_on */
	private void exitSequence_Microwave_System_Cook_Finish_finish_Finish_on() {
		nextStateIndex = 1;
		stateVector[1] = State.$NullState$;
		
		exitAction_Microwave_System_Cook_Finish_finish_Finish_on();
	}
	
	/* Default exit sequence for state Finish_off */
	private void exitSequence_Microwave_System_Cook_Finish_finish_Finish_off() {
		nextStateIndex = 1;
		stateVector[1] = State.$NullState$;
	...
	private void exitSequence_Microwave() {
		...
		case microwave_System_Cook_Finish_finish_Finish_on:
			...
			break;
		case microwave_System_Cook_Finish_finish_Finish_off:
			exitSequence_Microwave_System_Cook_Finish_finish_Finish_off();
			break;
		default:
			break;
		}
	...
	/* Default exit sequence for region finish */
	private void exitSequence_Microwave_System_Cook_Finish_finish() {
		switch (stateVector[1]) {
		case microwave_System_Cook_Finish_finish_Finish_on:
			exitSequence_Microwave_System_Cook_Finish_finish_Finish_on();
			break;
	...
	private boolean microwave_System_Cook_Cook_react(boolean try_transition) {
		boolean did_transition = try_transition;
	...
	private boolean microwave_System_Cook_Cook_cook_cook_active_react(boolean try_transition) {
		boolean did_transition = try_transition;
	...
	private boolean microwave_System_Cook_Finish_react(boolean try_transition) {
		boolean did_transition = try_transition;
		
		if (try_transition) {
			if (getTime()<=0) {
				exitSequence_Microwave_System_Cook_Finish();
				enterSequence_Microwave_System_Cook_Init_default();
			} else {
				did_transition = false;
			}
	...
	private boolean microwave_System_Cook_Finish_finish_Finish_on_react(boolean try_transition) {
		boolean did_transition = try_transition;
		
		if (try_transition) {
			if (microwave_System_Cook_Finish_react(try_transition)==false) {
				if (timeEvents[1]) {
					exitSequence_Microwave_System_Cook_Finish_finish_Finish_on();
					setTime((time - 1));
					
					enterSequence_Microwave_System_Cook_Finish_finish_Finish_off_default();
				} else {
					did_transition = false;
				}
			}
	...
	private boolean microwave_System_Cook_Finish_finish_Finish_off_react(boolean try_transition) {
		boolean did_transition = try_transition;
